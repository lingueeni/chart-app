...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f1120] via-[#1a1c2c] to-[#0f1120] text-gray-200 px-1 py-1">
      <div className="max-w-screen-2xl mx-auto space-y-12 px-4">
        <PageHeader />
